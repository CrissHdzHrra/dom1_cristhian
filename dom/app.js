...
const nombrealumno = "soy un alumno de la universidad tecnologica de durango, mi nombre es cristhian daniel hernandez herrera y este programa termino:";
...
btnGenerar.addEventListener('click', () => {
    ...
    if (correo === "" || !correo.includes('@')) {
        ...
        console.error("La entrada del correo no tiene @, porfavor vuelve a verificar el formato del correo.");
        return;
    }
    ...
    console.log("la accion de conversion de token ha sido descrifado correctamente.")
